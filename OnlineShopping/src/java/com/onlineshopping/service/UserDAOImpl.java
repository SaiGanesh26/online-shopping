...
public class UserDAOImpl implements UserDAO{
    ...
    public int create(User u) {
        ...
        try{
            if(isNewUser(u)){
        ds.setCon();
        ds.setSt("insert into User(firstName,lastName,mailId,phoneNumber,password,status) values(?,?,?,?,?,?)");
    ...
    public static void main(String[] arg){
        ...
        User u=new User("sai","ganesh","vuppala.saiganesh26@gmail.com","9876543210","123456");
        System.out.println(ud.isNewUser(u));
    }
    ...
    public boolean validateUser(User u,String OTP) {
        ...
        if(u.getStatus().equals("InValid") && OTP==null){
            ...
            ds.getCon();
            ds.setSt("Update User set status = 'Valid' where Id=?");
    ...
    public User read(User u) {
        try{
            ds.setCon();
            ds.setSt("select * from User where mailId=?");
